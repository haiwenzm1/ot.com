    ...
    $('#main').fullpage({
        ...
        afterLoad: function(anchorLink, index) {
            ...
            if (index == 4) {
                ...
                $('.banner5-wrap #banner5-vedio-click').animate({ 'opacity': '1', 'left': '82vw' }, 2000);
                ...
                $('#banner5-vedio-click').click(function() {
                    $('#fp-nav').hide();
                    $.fn.fullpage.setAllowScrolling(false);
                    $('.banner5-vedio-layout').show();
                    $('.banner5-vedio-layout-content-close').show();
                ...
                $(document).on('click', '.banner5-vedio-layout-content-close', function() {
                    var myPlayer = videojs('my-video');
                    videojs("my-video").ready(function() {
                        var myPlayer = this;
                        myPlayer.pause();
                    });
                    $('.banner5-vedio-layout').hide();
                    $('.banner5-vedio-layout-content-close').hide();
                    $('#fp-nav').show();
                    $.fn.fullpage.setAllowScrolling(true);
                })
