...
insert  into `ot_member`(`uid`,`nickname`,`sex`,`birthday`,`qq`,`score`,`login`,`reg_ip`,`reg_time`,`last_login_ip`,`last_login_time`,`status`) values (1,'admin',0,'0000-00-00','',50,36,0,1488894592,167772674,1497422528,1);
...
insert  into `ot_ucenter_member`(`id`,`username`,`password`,`email`,`mobile`,`reg_time`,`reg_ip`,`last_login_time`,`last_login_ip`,`update_time`,`status`) values (1,'admin','6c1b671f0fe771f8742501f32c1f8bcd','896582248@qq.com','',1488894592,3232270605,1497422528,167772674,1488894592,1);
