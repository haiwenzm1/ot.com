...
insert  into `ot_member`(`uid`,`nickname`,`sex`,`birthday`,`qq`,`score`,`login`,`reg_ip`,`reg_time`,`last_login_ip`,`last_login_time`,`status`) values (1,'admin',0,'0000-00-00','',100,40,0,1488894592,167772674,1491018700,1);
...
CREATE TABLE `ot_operate_log` (
  ...
  `model` varchar(50) NOT NULL DEFAULT '' COMMENT '触发行为的表',
  `remark` varchar(512) NOT NULL DEFAULT '' COMMENT '日志备注',
  `action_ip` bigint(20) NOT NULL COMMENT '执行行为者ip',
...
insert  into `ot_operate_log`(`id`,`model`,`remark`,`action_ip`,`status`,`creator`,`create_time`) values (1,'ProductCategory/upload','上传图片cfdasvfdas成功,id=4',100,1,1,1491039865),(2,'ProductCategory/upload','上传图片cfdasvfdas成功,id=5',167772674,1,1,1491040172);
...
insert  into `ot_picture_record`(`id`,`rid`,`path`,`name`,`oname`,`size`,`title`,`description`,`source`,`type`,`status`,`creator`,`ctime`,`updater`,`utime`,`version`) values (1,0,'cdasfhgfdhgddgf','cfdasvfdas','fdasfdas','2300','','',0,0,1,1,1491018812,1,1491018812,0),(2,0,'cdasfhgfdhgddgf','cfdasvfdas','fdasfdas','2300','','',0,0,1,1,1491019183,1,1491019183,0),(3,0,'cdasfhgfdhgddgf','cfdasvfdas','fdasfdas','2300','','',0,0,1,1,1491039542,1,1491039542,0),(4,0,'cdasfhgfdhgddgf','cfdasvfdas','fdasfdas','2300','','',0,0,1,1,1491039865,1,1491039865,0),(5,0,'cdasfhgfdhgddgf','cfdasvfdas','fdasfdas','2300','','',0,0,1,1,1491040172,1,1491040172,0);
...
insert  into `ot_product_category`(`id`,`name`,`title`,`pid`,`sort`,`meta_title`,`keywords`,`description`,`cover`,`islast`,`status`,`create_time`,`update_time`,`creator`,`updater`) values (1,'nanzhuang','男装',0,0,'ss','ss','ss','1',0,1,1488984663,1490252405,0,0),(3,'nanshikuzi','男式裤子',1,2,'','','',NULL,0,1,1489055948,1489239794,0,0),(2,'nanshiwaitao','男士外套',1,1,'','','',NULL,0,1,1489055859,1489244273,0,0),(4,'nvzhuang','女装',0,1,'','','',NULL,0,1,1489056102,1490251622,0,0),(5,'nvshiwaitao','女士外套',4,2,'','','',NULL,0,1,1489056170,1489239735,0,0),(6,'nvshikuzi','女士裤子',4,1,'','','',NULL,0,1,1489056194,1489056194,0,0),(7,'nanshijiake','夹克1',2,0,'','','',NULL,0,1,1489056220,1490255753,0,0),(17,'hgdhgdgd','hghgd',3,3,'','','',NULL,1,1,1489290373,1490252454,0,0),(15,'dsaS','dsad',3,2,'','','',NULL,0,1,1489252266,1490252436,0,0),(14,'tongzhuang','童装',0,2,'','','',NULL,0,1,1489138435,1489978948,0,0),(18,'advfavafdv','cdsavadv',14,0,'','','',NULL,0,1,1489293040,1489293040,0,0),(22,'fdga','fdsafdsaf',3,1,'','','',NULL,0,1,1489293192,1490252525,0,0),(23,'gfsdgdsgfsdg','gfdsgsdfg',22,0,'','','',NULL,0,1,1490177394,1490177394,0,0),(24,'ghfjghfjghfjgfhj','kjgfjghfjgfj',23,0,'','','',NULL,0,1,1490177407,1490177407,0,0);
...
insert  into `ot_ucenter_member`(`id`,`username`,`password`,`email`,`mobile`,`reg_time`,`reg_ip`,`last_login_time`,`last_login_ip`,`update_time`,`status`) values (1,'admin','6c1b671f0fe771f8742501f32c1f8bcd','896582248@qq.com','',1488894592,3232270605,1491018700,167772674,1488894592,1);
