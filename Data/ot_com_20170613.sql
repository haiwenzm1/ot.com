...
insert  into `ot_member`(`uid`,`nickname`,`sex`,`birthday`,`qq`,`score`,`login`,`reg_ip`,`reg_time`,`last_login_ip`,`last_login_time`,`status`) values (1,'admin',0,'0000-00-00','',50,34,0,1488894592,2130706433,1497358471,1);
...
CREATE TABLE `ot_product_category` (
  ...
  UNIQUE KEY `uk_name` (`name`),
  KEY `pid` (`pid`)
) ENGINE=MyISAM AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='产品分类表';

/*Data for the table `ot_product_category` */

insert  into `ot_product_category`(`id`,`name`,`title`,`pid`,`sort`,`meta_title`,`keywords`,`description`,`islast`,`status`,`create_time`,`update_time`,`creator`,`updater`) values (1,'nanzhuang','男装',0,0,'ss','ss','ss',0,1,1488984663,1489055887,0,0),(3,'nanshikuzi','男式裤子',1,2,'','','',0,1,1489055948,1489239794,0,0),(2,'nanshiwaitao','男士外套',1,1,'','','',0,1,1489055859,1489244273,0,0),(4,'nvzhuang','女装',0,0,'','','',0,1,1489056102,1489056148,0,0),(5,'nvshiwaitao','女士外套',4,2,'','','',0,1,1489056170,1489239735,0,0),(6,'nvshikuzi','女士裤子',4,1,'','','',0,1,1489056194,1489056194,0,0),(7,'nanshijiake','夹克',2,0,'','','',0,1,1489056220,1489056220,0,0),(17,'hgdhgdgd','hghgd',3,1,'','','',1,1,1489290373,1489324760,0,0),(15,'dsaS','dsad',3,0,'','','',0,1,1489252266,1489252266,0,0),(14,'tongzhuang','童装',0,3,'','','',0,1,1489138435,1489138435,0,0),(18,'advfavafdv','cdsavadv',14,0,'','','',0,1,1489293040,1489293040,0,0),(22,'fdga','fdsafdsaf',3,0,'','','',0,1,1489293192,1489293192,0,0);
...
insert  into `ot_ucenter_member`(`id`,`username`,`password`,`email`,`mobile`,`reg_time`,`reg_ip`,`last_login_time`,`last_login_ip`,`update_time`,`status`) values (1,'admin','6c1b671f0fe771f8742501f32c1f8bcd','896582248@qq.com','',1488894592,3232270605,1497358471,2130706433,1488894592,1);
